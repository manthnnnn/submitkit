...
echo ""
echo -e "${CYAN} ============================================================"
echo -e "  TALENTSCAN AI - ATS & Resume Parsing Engine"
...
echo ""
echo -e "${CYAN}  PROJECT: http://localhost:3005   CANDIDATES: http://localhost:3005/candidates${NC}"
echo ""
[[ "$OSTYPE" == "darwin"* ]] && sleep 2 && open "http://localhost:3005" &
npm run dev -- -p 3005 -H 0.0.0.0
