...
echo ""
echo -e "${CYAN} ============================================================"
echo -e "  DEVFORGE CLOUD SANDBOX & AI CODE DOCTOR"
...
echo ""
echo -e "${CYAN}  PROJECT: http://localhost:3006   DASHBOARD: http://localhost:3006/dashboard${NC}"
echo ""
[[ "$OSTYPE" == "darwin"* ]] && sleep 2 && open "http://localhost:3006" &
