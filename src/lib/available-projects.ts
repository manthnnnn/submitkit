...
export const READY_PROJECTS: Record<string, AvailableProjectMeta> = {
  'healthcare-ehr-portal': {
    ...
    category: 'Healthcare',
    port: 3003,
    liveUrl: '/demo/healthcare-ehr-portal',
  ...
  'blood-bank-management': {
    ...
    category: 'Healthcare',
    port: 3004,
    liveUrl: '/demo/blood-bank-management',
  ...
  'resume-parsing-engine': {
    ...
    category: 'AIML',
    port: 3005,
    liveUrl: '/demo/resume-parsing-engine',
  ...
  'online-code-compiler': {
    ...
    category: 'Cloud',
    port: 3006,
    liveUrl: '/demo/online-code-compiler',
  ...
  'credit-card-fraud': {
    ...
    category: 'FinTech',
    port: 3007,
    liveUrl: '/demo/credit-card-fraud',
  ...
  'phishing-detector-ai': {
    ...
    port: 3008,
    liveUrl: '/demo/phishing-detector-ai',
  ...
  'restaurant-qr-ordering': {
    ...
    category: 'FullStack',
    port: 3002,
    liveUrl: '/demo/restaurant-qr-ordering',
  ...
  'aerofuel-predictor': {
    ...
    category: 'AIML',
    port: 3010,
    liveUrl: '/demo/aerofuel-predictor',
  ...
  'smart-expense-tracker': {
    ...
    category: 'FinTech',
    port: 3009,
    liveUrl: '/demo/smart-expense-tracker',
