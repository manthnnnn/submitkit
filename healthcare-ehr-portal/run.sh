...
echo ""
echo -e "${CYAN} ============================================================"
echo -e "  HEALTHSYNC EHR & TELEHEALTH PORTAL"
...
echo ""
echo -e "${CYAN}  PROJECT: http://localhost:3003   DASHBOARD: http://localhost:3003/dashboard${NC}"
echo ""
[[ "$OSTYPE" == "darwin"* ]] && sleep 2 && open "http://localhost:3003" &
