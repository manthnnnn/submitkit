...
echo ""
echo -e "${CYAN} ============================================================"
echo -e "  SENTINELPAY AI - Credit Card Fraud Detection Engine"
...
echo ""
echo -e "${CYAN}  PROJECT: http://localhost:3007   DASHBOARD: http://localhost:3007/dashboard${NC}"
echo ""
[[ "$OSTYPE" == "darwin"* ]] && sleep 2 && open "http://localhost:3007" &
npm run dev -- -p 3007 -H 0.0.0.0
