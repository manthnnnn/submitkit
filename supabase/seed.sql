...
(
    ...
    'bundles/mini/phishing-detector-ai.zip',
    'templates/mini/phishing-detector-ai-report.docx',
    ARRAY['/projects/phishing-detector-ai.jpg']
),
(
    'network-ids',
    'Intrusion Detection System (IDS)',
    ...
    'bundles/major/network-ids.zip',
    'templates/major/network-ids-report.docx',
    ARRAY['/projects/network-ids.jpg']
),
(
    'steganography-tool',
    'Secure Steganography Vault',
    ...
    'bundles/mini/steganography-tool.zip',
    'templates/mini/steganography-tool-report.docx',
    ARRAY['/projects/steganography-tool.jpg']
),
(
    'ransomware-sandbox',
    'Ransomware Behavior Sandbox',
    ...
    'bundles/major/ransomware-sandbox.zip',
    'templates/major/ransomware-sandbox-report.docx',
    ARRAY['/projects/ransomware-sandbox.jpg']
),
(
    'keylogger-detector',
    'Heuristic Keylogger Detector',
    ...
    'bundles/mini/keylogger-detector.zip',
    'templates/mini/keylogger-detector-report.docx',
    ARRAY['/projects/keylogger-detector.jpg']
),
(
    'sql-injection-scanner',
    'Automated SQLi Vulnerability Scanner',
    ...
    'bundles/mini/sql-injection-scanner.zip',
    'templates/mini/sql-injection-scanner-report.docx',
    ARRAY['/projects/sql-injection-scanner.jpg']
),
(
    'blockchain-identity',
    'Decentralized Identity (DID) Auth',
    ...
    'bundles/major/blockchain-identity.zip',
    'templates/major/blockchain-identity-report.docx',
    ARRAY['/projects/blockchain-identity.jpg']
),
(
    'honey-pot-server',
    'Deceptive Honeypot Server',
    ...
    'bundles/major/honey-pot-server.zip',
    'templates/major/honey-pot-server-report.docx',
    ARRAY['/projects/honey-pot-server.jpg']
),
(
    'password-strength-nn',
    'Neural Net Password Strength Analyzer',
    ...
    'bundles/mini/password-strength-nn.zip',
    'templates/mini/password-strength-nn-report.docx',
    ARRAY['/projects/password-strength-nn.jpg']
),
(
    'wifi-deauth-monitor',
    'Wi-Fi Deauthentication Monitor',
    ...
    'bundles/mini/wifi-deauth-monitor.zip',
    'templates/mini/wifi-deauth-monitor-report.docx',
    ARRAY['/projects/wifi-deauth-monitor.jpg']
),
(
    'smart-agriculture-iot',
    'IoT Precision Agriculture System',
    'IoT',
    'MAJOR',
    499,
    'Soil moisture, NPK, and temperature monitoring with automated water pump control.',
    ARRAY['Arduino', 'ESP32', 'MQTT', 'React'],
    ARRAY['Real-time telemetry', 'Automated irrigation', 'Weather API integration'],
    'https://ui.shadcn.com/examples/dashboard',
    'bundles/major/smart-agriculture-iot.zip',
    'templates/major/smart-agriculture-iot-report.docx',
    ARRAY['/projects/smart-agriculture-iot.jpg']
),
(
    'iot-patient-monitor',
    ...
    'MAJOR',
    499,
    'Wearable simulation for heart rate and SpO2 monitoring with emergency cloud alerts.',
    ARRAY['NodeMCU', 'Firebase', 'Flutter', 'C++'],
    ARRAY['Vitals dashboard', 'Emergency thresholds', 'Doctor portal'],
    'https://ui.shadcn.com/examples/cards',
    'bundles/major/iot-patient-monitor.zip',
    'templates/major/iot-patient-monitor-report.docx',
    ARRAY['/projects/iot-patient-monitor.jpg']
),
(
    'smart-parking-iot',
    'IoT Smart Parking Allocation',
    'IoT',
    'MINI',
    299,
    'IR sensor based parking spot detection with a web dashboard for available slots.',
    ARRAY['ESP8266', 'Node.js', 'Socket.io', 'HTML/CSS'],
    ARRAY['Slot availability', 'Entry/Exit gate control', 'Live updates'],
    'https://ui.shadcn.com/examples/tasks',
    'bundles/mini/smart-parking-iot.zip',
    'templates/mini/smart-parking-iot-report.docx',
    ARRAY['/projects/smart-parking-iot.jpg']
),
(
    'rfid-toll-collection',
    'Automated RFID Toll Collection',
    'IoT',
    'MINI',
    299,
    'RFID reader integration that automatically deducts balance from user accounts at tolls.',
    ARRAY['Arduino', 'RFID RC522', 'PHP', 'MySQL'],
    ARRAY['Balance deduction', 'Admin panel', 'Low balance alerts'],
    'https://ui.shadcn.com/examples/forms',
    'bundles/mini/rfid-toll-collection.zip',
    'templates/mini/rfid-toll-collection-report.docx',
    ARRAY['/projects/rfid-toll-collection.jpg']
),
(
    'iot-garbage-bin',
    'Smart City Garbage Bin Monitor',
    'IoT',
    'MINI',
    299,
    'Ultrasonic sensor integration to measure garbage fill levels and optimize collection routes.',
    ARRAY['ESP32', 'Ultrasonic HC-SR04', 'Google Maps API'],
    ARRAY['Fill level percentage', 'Route optimization', 'City dashboard'],
    'https://ui.shadcn.com/examples/dashboard',
    'bundles/mini/iot-garbage-bin.zip',
    'templates/mini/iot-garbage-bin-report.docx',
    ARRAY['/projects/iot-garbage-bin.jpg']
),
(
    ...
    'MINI',
    299,
    'Control home appliances using Google Assistant/Alexa webhooks and an ESP8266.',
    ARRAY['ESP8266', 'IFTTT', 'Adafruit IO', 'Relay Modules'],
    ARRAY['Voice commands', 'Manual override web UI', 'Power scheduling'],
    'https://ui.shadcn.com/examples/cards',
    'bundles/mini/home-automation-voice.zip',
    'templates/mini/home-automation-voice-report.docx',
    ARRAY['/projects/home-automation-voice.jpg']
),
(
    'iot-energy-meter',
    ...
    'MAJOR',
    499,
    'Measures AC voltage/current and calculates power consumption, displaying costs in real-time.',
    ARRAY['ESP32', 'PZEM-004T', 'InfluxDB', 'Grafana'],
    ARRAY['Power tracking', 'Cost estimation', 'Overload cutoff'],
    'https://ui.shadcn.com/examples/music',
    'bundles/major/iot-energy-meter.zip',
    'templates/major/iot-energy-meter-report.docx',
    ARRAY['/projects/iot-energy-meter.jpg']
),
(
    'iot-weather-station',
    ...
    'MINI',
    299,
    'Local weather station measuring temp, humidity, pressure, and air quality (AQI).',
    ARRAY['Arduino', 'BME280', 'MQ135', 'ThingSpeak'],
    ARRAY['Data logging', 'AQI calculation', 'Historical graphs'],
    'https://ui.shadcn.com/examples/dashboard',
    'bundles/mini/iot-weather-station.zip',
    'templates/mini/iot-weather-station-report.docx',
    ARRAY['/projects/iot-weather-station.jpg']
),
(
    'rfid-attendance-iot',
    ...
    'MINI',
    299,
    'Tap-in attendance system that logs entries directly to a cloud Google Sheet.',
    ARRAY['NodeMCU', 'RFID', 'Google Apps Script'],
    ARRAY['Direct to Excel', 'Buzzer feedback', 'Duplicate scan prevention'],
    'https://ui.shadcn.com/examples/tasks',
    'bundles/mini/rfid-attendance-iot.zip',
    'templates/mini/rfid-attendance-iot-report.docx',
    ARRAY['/projects/rfid-attendance-iot.jpg']
),
(
    'iot-fall-detector',
    'Elderly Fall Detection Wearable',
    'IoT',
    'MAJOR',
    499,
    'MPU6050 accelerometer based system to detect sudden falls and send SMS alerts.',
    ARRAY['ESP32', 'MPU6050', 'Twilio API', 'React Native'],
    ARRAY['Fall algorithm', 'GPS location', 'SMS emergency alert'],
    'https://ui.shadcn.com/examples/mail',
    'bundles/major/iot-fall-detector.zip',
    'templates/major/iot-fall-detector-report.docx',
    ARRAY['/projects/iot-fall-detector.jpg']
),
(
    'stock-predictor-lstm',
    'Stock Market Predictor (LSTM)',
    ...
    'bundles/major/stock-predictor-lstm.zip',
    'templates/major/stock-predictor-lstm-report.docx',
    ARRAY['/projects/stock-predictor-lstm.jpg']
),
(
    'credit-card-fraud',
    'Credit Card Fraud Detection',
    ...
    'bundles/mini/credit-card-fraud.zip',
    'templates/mini/credit-card-fraud-report.docx',
    ARRAY['/projects/credit-card-fraud.jpg']
),
(
    'customer-churn-ml',
    'Telecom Customer Churn Predictor',
    ...
    'bundles/mini/customer-churn-ml.zip',
    'templates/mini/customer-churn-ml-report.docx',
    ARRAY['/projects/customer-churn-ml.jpg']
),
(
    'movie-recommender',
    'Collaborative Movie Recommender',
    ...
    'bundles/mini/movie-recommender.zip',
    'templates/mini/movie-recommender-report.docx',
    ARRAY['/projects/movie-recommender.jpg']
),
(
    'pneumonia-xray-cnn',
    'Pneumonia Detection from X-Rays',
    ...
    'bundles/major/pneumonia-xray-cnn.zip',
    'templates/major/pneumonia-xray-cnn-report.docx',
    ARRAY['/projects/pneumonia-xray-cnn.jpg']
),
(
    'twitter-sentiment-analysis',
    'Real-time Twitter Sentiment Analysis',
    ...
    'bundles/major/twitter-sentiment-analysis.zip',
    'templates/major/twitter-sentiment-analysis-report.docx',
    ARRAY['/projects/twitter-sentiment-analysis.jpg']
),
(
    'house-price-prediction',
    'Real Estate Price Predictor',
    ...
    'bundles/mini/house-price-prediction.zip',
    'templates/mini/house-price-prediction-report.docx',
    ARRAY['/projects/house-price-prediction.jpg']
),
(
    'sign-language-translator',
    'Sign Language to Text Translator',
    ...
    'bundles/major/sign-language-translator.zip',
    'templates/major/sign-language-translator-report.docx',
    ARRAY['/projects/sign-language-translator.jpg']
),
(
    'spam-classifier-nlp',
    'SMS Spam Classifier (NLP)',
    ...
    'bundles/mini/spam-classifier-nlp.zip',
    'templates/mini/spam-classifier-nlp-report.docx',
    ARRAY['/projects/spam-classifier-nlp.jpg']
),
(
    'driver-drowsiness-alert',
    'Driver Drowsiness Detection',
    ...
    'bundles/major/driver-drowsiness-alert.zip',
    'templates/major/driver-drowsiness-alert-report.docx',
    ARRAY['/projects/driver-drowsiness-alert.jpg']
),
(
    'nft-marketplace',
    'Decentralized NFT Marketplace',
    ...
    'bundles/major/nft-marketplace.zip',
    'templates/major/nft-marketplace-report.docx',
    ARRAY['/projects/nft-marketplace.jpg']
),
(
    'supply-chain-blockchain',
    'Blockchain Supply Chain Tracker',
    ...
    'bundles/major/supply-chain-blockchain.zip',
    'templates/major/supply-chain-blockchain-report.docx',
    ARRAY['/projects/supply-chain-blockchain.jpg']
),
(
    'crypto-crowdfunding',
    'Web3 Crowdfunding Platform',
    ...
    'bundles/major/crypto-crowdfunding.zip',
    'templates/major/crypto-crowdfunding-report.docx',
    ARRAY['/projects/crypto-crowdfunding.jpg']
),
(
    'dapp-staking',
    'DeFi Staking DApp',
    ...
    'bundles/major/dapp-staking.zip',
    'templates/major/dapp-staking-report.docx',
    ARRAY['/projects/dapp-staking.jpg']
),
(
    'fake-product-identification',
    'Fake Product Identification Web3',
    ...
    'bundles/major/fake-product-identification.zip',
    'templates/major/fake-product-identification-report.docx',
    ARRAY['/projects/fake-product-identification.jpg']
),
(
    'decentralized-cloud-storage',
    'Web3 Dropbox (IPFS)',
    ...
    'bundles/major/decentralized-cloud-storage.zip',
    'templates/major/decentralized-cloud-storage-report.docx',
    ARRAY['/projects/decentralized-cloud-storage.jpg']
),
(
    'blockchain-land-registry',
    'Blockchain Land Registry System',
    ...
    'bundles/major/blockchain-land-registry.zip',
    'templates/major/blockchain-land-registry-report.docx',
    ARRAY['/projects/blockchain-land-registry.jpg']
),
(
    'web3-freelance-platform',
    'Decentralized Freelance Platform',
    ...
    'bundles/major/web3-freelance-platform.zip',
    'templates/major/web3-freelance-platform-report.docx',
    ARRAY['/projects/web3-freelance-platform.jpg']
),
(
    'crypto-portfolio-tracker',
    'Crypto Portfolio Tracker',
    ...
    'bundles/mini/crypto-portfolio-tracker.zip',
    'templates/mini/crypto-portfolio-tracker-report.docx',
    ARRAY['/projects/crypto-portfolio-tracker.jpg']
),
(
    'blockchain-notary',
    'Blockchain Document Notary',
    ...
    'bundles/mini/blockchain-notary.zip',
    'templates/mini/blockchain-notary-report.docx',
    ARRAY['/projects/blockchain-notary.jpg']
),
(
    'alumni-networking-portal',
    'College Alumni Networking Portal',
    ...
    'bundles/major/alumni-networking-portal.zip',
    'templates/major/alumni-networking-portal-report.docx',
    ARRAY['/projects/alumni-networking-portal.jpg']
),
(
    'online-code-compiler',
    'Cloud Remote Code Compiler',
    ...
    'bundles/major/online-code-compiler.zip',
    'templates/major/online-code-compiler-report.docx',
    ARRAY['/projects/online-code-compiler.jpg']
),
(
    'blood-bank-management',
    'Smart Blood Bank Management',
    ...
    'bundles/mini/blood-bank-management.zip',
    'templates/mini/blood-bank-management-report.docx',
    ARRAY['/projects/blood-bank-management.jpg']
),
(
    'virtual-try-on',
    'AR Virtual Glasses Try-On',
    ...
    'bundles/major/virtual-try-on.zip',
    'templates/major/virtual-try-on-report.docx',
    ARRAY['/projects/virtual-try-on.jpg']
),
(
    'restaurant-qr-ordering',
    'QR Code Restaurant Ordering',
    ...
    'bundles/mini/restaurant-qr-ordering.zip',
    'templates/mini/restaurant-qr-ordering-report.docx',
    ARRAY['/projects/restaurant-qr-ordering.jpg']
),
(
    'plagiarism-checker-tool',
    'Document Plagiarism Checker',
    ...
    'bundles/mini/plagiarism-checker-tool.zip',
    'templates/mini/plagiarism-checker-tool-report.docx',
    ARRAY['/projects/plagiarism-checker-tool.jpg']
),
(
    'task-management-kanban',
    'Agile Kanban Task Manager',
    ...
    'bundles/mini/task-management-kanban.zip',
    'templates/mini/task-management-kanban-report.docx',
    ARRAY['/projects/task-management-kanban.jpg']
),
(
    'e-learning-lms',
    'E-Learning Course Platform',
    ...
    'bundles/major/e-learning-lms.zip',
    'templates/major/e-learning-lms-report.docx',
    ARRAY['/projects/e-learning-lms.jpg']
),
(
    'bug-tracking-system',
    'Enterprise Bug Tracking System',
    ...
    'bundles/major/bug-tracking-system.zip',
    'templates/major/bug-tracking-system-report.docx',
    ARRAY['/projects/bug-tracking-system.jpg']
),
(
    'real-estate-bidding',
    'Real Estate Auction & Bidding',
    ...
    'bundles/major/real-estate-bidding.zip',
    'templates/major/real-estate-bidding-report.docx',
    ARRAY['/projects/real-estate-bidding.jpg']
)
ON CONFLICT (slug) DO NOTHING;
